	...
	<div class="modal-dialog modal-xl shadow">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<input type="number" name="hours" step="0.01" value="00:00" class="form-control" required>
				</div>
				<!-- <div class="col-6">
			...
			<div class="col-8">
				<div class="container-fluid text-center">
					...
					<div class="cust">
				<?php 
				$history=mysqli_query($con,"select * from history where team_id=".$_SESSION['u_id']." and task_row_id=".$get_detailes['id']." order by id desc");$i=0;
